<?php
$my_email = "registration@mvml.org";
$errors = array();
...
Thank you for registering for MVML 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@mvml.org. You can find the copyright form here: www.mvml.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for MVML'18";

$your_headers = "From: MVML'18 <" . $my_email . ">";
...
<title>MVML'18 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>4<sup>th</sup> International Conference on Machine Vision and Machine Learning (MVML'18)</h1>
...
<br><p class="body" style="text-align:center!important; color: #FFF!important;">MVML'18 is part of the <b>4<sup>th</sup> World Congress on Electrical Engineering and Computer Systems and Science (EECSS'18)</b>.<br>For more information about the congress, please visit the website here: <a href="http://2018.eecss.org/" class="body-link">www.2018.eecss.org</a>.</p>
        </div>
        </div> 
      </div>
    </div>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">MVML 2018:</p>
      <p class="body">MVML 2018 will  be held in Madrid, Spain on August 21 - 23, 2018.</p>
...
<!-- 
    ...
    <div>
      ...
      <p class="body">MVML attracts a wide range of researchers in the field of biomedical engineering and systems. As a prominent company in the field of biomedical engineering and systems, we would like to offer you an exhibit at MVML. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
    ...
    <p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@mvml.org" class="body-link">registration@mvml.org</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

  <p class="body">We are looking forward to seeing you at MVML'18!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
    ...
    +1-613-834-9999<br>
    <a href="mailto:info@mvml.org">info@mvml.org</a></p>
    </div>
  </div>

  <div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding MVML'18, please fill out the form below:</p>
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LdCUf8SAAAAAGr0_ZG_AuAkmgRoVRIth0z9bLY0"></div></center>
  <div class="cf">

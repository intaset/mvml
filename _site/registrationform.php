...
$your_subject = "Your Registration Details for MVML'19";

$your_headers = "From: MVML'19 <" . $my_email . ">";
...
<title>MVML'19 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>5<sup>th</sup> International Conference on Machine Vision and Machine Learning (MVML'19)</h1>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at MVML'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding MVML'19, please fill out the form below:</p>
